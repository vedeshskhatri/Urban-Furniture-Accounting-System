...
export const VendorStatementRoute: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-4">
      <div>
        <h1 className="text-2xl font-bold font-display text-brown-900">Payment</h1>
        <p className="text-sm text-brown-700">Vendor ledger activity, disbursements &amp; running balances</p>
      </div>
